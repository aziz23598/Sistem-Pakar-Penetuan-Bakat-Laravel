...
<div class="row bg-primary p-3 text-light">
  <h2>Tes Bakat Anak </h2>
</div>
<div class="row bg-primary p-3 text-light">
  <span class="responsive"><img src="{{url('image/badge.png')}}" class="img-fluid" alt="achivement" ></span>
  <h5>Ayo cari tahu bakat mu dengan mengikuti tes bakat anak secara online</h5>
  <h3>GRATIS!!!</h3>
  <h5>Agar kamu tahu bakat yang kamu miliki</h5>
  <a href="/login"><button class="btn btn-warning btn-lg" type="submit"> login</button></a>
</div>
</div>
