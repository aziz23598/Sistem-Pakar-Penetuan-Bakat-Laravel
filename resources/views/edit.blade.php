    ...
    <div class="jumbotron">
        <table class="table">
            <form method="POST" action="/profile/update/{{Auth::user()->id }}">
                @csrf
            <tr>
                <th colspan="2"><h2>Edit Data Diri</h2></th>
            </tr>
            <tr>
            ...
            <tr>
                <td class="text-start" width="100px">Email</td>
                <td>: <input style="width: 500px" type="text" name="email" value="{{ $user->email }}"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><select class="form-select" id="pendidikan" name="pendidikan" s>
            ...
            <tr>
                <td colspan="2"><button class=" btn btn-md btn-success" type="submit"> Simpan </button></td>
            </tr>
        </table>          
    </div>
</div>
