  ...
  <body class="bg-light">
    ...
    <section class="ombak">
      <div class="container mt-4 text-center">
        ...
        <div class="row bg-primary p-3 text-light">
            <a href="/soal" style="color: #F0F8FF"> <h4 align="left">Data Soal</h4></a>
            <a href="/data-bakat" style="color: #F0F8FF"> <h4 align="left">Data Bakat</h4></a>
            <a href="/user" style="color: #F0F8FF"><h4 align="left"> Data User</h4></a>
          </div>
