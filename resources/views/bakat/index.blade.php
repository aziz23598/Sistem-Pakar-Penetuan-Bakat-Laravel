      ...
      <div class="container mt-4 text-center">
        ...
        <div class="row bg-primary p-3 text-light">
                    <table width="100%"> 
                        ...
                        <tbody> 
                        @foreach ($bakat as $key=>$b) 
                            <tr> 
                                <td align="center">{{$b->id}}.</td>
                                <td align="left"> {{ $b->bakat }}</td> 
                                <td align="left"> {{ $b->profesi }}</td> 
                                <td align="center">
                                        <a class="btn btn-sm btn-success" href="{{ url('bakat/'.$b->id) }}"> Edit</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
