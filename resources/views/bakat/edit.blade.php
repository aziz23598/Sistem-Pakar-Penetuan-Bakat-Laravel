    ...
    <section class="ombak">
      <div class="container mt-4 text-center">
        <div class="row bg-primary p-3 text-light">
                    <table width="100%">  
                        <thead>
                            <th colspan="2">Edit Bakat No {{$bakat->id}}<hr /></th>
                        </thead>
                        <tbody> 
                            <form method="POST" action="{{ url('bakat/update/'.$bakat->id) }} ">
                            @csrf
                            <tr> 
                                <td >Bakat </td>
                                <td>: <input style="width: 500px" type="text" name="bakat" value="{{ $bakat->bakat }}"></td>
                            </tr>
                            <tr>
                                <td >Profesi </td>
                                <td>: <input style="width: 500px" type="text" name="profesi" value="{{ $bakat->profesi }}"></td>
                            </tr>
                            <tr>
                                <td align="center" colspan="2">
                                    <x-button type="submit" class="btn btn-sm btn-success">Simpan</x-button>
                                </td>
                            </tr>
                            </form>
                        </tbody>
