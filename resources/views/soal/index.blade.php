  ...
  <body class="bg-light">
    ...
    <section class="ombak">
      <div class="container mt-4 text-center">
        ...
        <div class="row bg-primary p-3 text-light">
          <div class="d-flex">
            <a class="btn btn-md btn-success" href="/soal/tambah">+ Tambah Soal</a>
          </div>
                    <table width="100%"> 
                        <thead> 
                            <tr> 
                        ...
                        @foreach ($soal as $key=>$s) 
                            <tr> 
                                ...
                                <td align="left"> {{ $s->soal }}</td> 
                                <td align="center"> {{ $s->cf_pakar }}</td> 
                                <td align="center">
                                        <a class="btn btn-sm btn-success" href="{{ url('soal/'.$s->id) }}"> Edit</a>
                                        <a class="btn btn-sm btn-danger" href="{{ url('soal/delete/'.$s->id) }}" onclick="return confirm('Apakah yakin ingin menghapus data?')">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                            <tr>
