      ...
      <div class="container mt-4 text-center">
        <div class="row bg-primary p-3 text-light">
            <table >  
                <thead>
                    <tr>
                        <th colspan="2">Edit Soal No {{$soal->id}}<hr /></th>
                    </tr>
                </thead>
                <tbody> 
                    <form method="POST" action="{{ url('soal/update/'.$soal->id) }} ">
                    @csrf
                        <tr> 
                            <td >Soal </td>
                            <td><input style="width: 500px" type="text" name="soal" value="{{ $soal->soal }}"></td>
                        </tr>
                        <tr> 
                          <td >CF Pakar </td>
                          <td> <input style="width: 500px" type="text" name="cf_pakar" value="{{ $soal->cf_pakar }}"></td>
                      </tr>
                        <tr >
                          <td colspan="2">
